...
export default function OrderDetail() {
  ...
  <div className="flex-1">
    ...
    <div className="grid grid-cols-2 gap-10 mb-6">
      {/* Loomiz Team */}
      <div>
        <h4 className="text-[#3F72AF] font-[NSmedium] font-semibold text-[24px]">LOOMIZ TEAM</h4>
      ...
      <div>
        <h4 className="text-[#3F72AF]  font-semibold  font-[NSmedium] mb-1 text-[24px]">MANUFACTURER ASSIGNED</h4>
    ...
    <div className="grid grid-cols-2 gap-10">
      {/* Details */}
      <div>
        <h4 className="text-[#3F72AF] font-[NSmedium] font-semibold mb-1 text-[24px]">DETAILS</h4>
      ...
      <div>
            ...
            {/* Design Section */}
            <div className="mt-12">
              <h4 className="text-[#194185] font-bold mb-4 text-[32px]">DESIGN</h4>
              ...
              <div className="flex gap-10">
                ...
                <div className="flex-1 space-y-6">
                  {/* Colours */}
                  <div>
                    <h4 className="text-[#3F72AF]  font-semibold mb-2 text-[20px] ">COLOURS</h4>
                    <div className="grid grid-cols-3 gap-2">
                      {Array.from({ length: 12 }).map((_, i) => (
                        <div key={i} className="flex items-center gap-2">
                          <div className="w-[20px] h-[20px]   bg-[#979797]" />
                          <span className="text-sm font-semibold font-[NSregular] text-gray-700">#FFFFFF</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  {/* Sizes */}
                  <div>
                    <h4 className="text-[#3F72AF]  font-semibold mb-2 text-[20px]">SIZES</h4>
                    <div className="flex flex-wrap gap-4">
                      {['XL', 'L', 'M', 'S', 'XS'].map(size => (
                        <div key={size} className="flex items-center gap-2">
                          <div className="w-[20px] h-[20px]  bg-[#979797]" />
                          <span className="font-[NSregular] font-semibold">{size}</span>
                        </div>
                      ))}
                    </div>
                  </div>
