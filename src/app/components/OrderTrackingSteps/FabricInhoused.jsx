const FabricInhoused = () => {
    return (
        <div className="mx-30 my-10  shadow-md border border-[#E0E0E0] bg-white">
      <div className="flex justify-between items-center px-4 py-3 bg-white">
        <h2 className="   font-[NSmedium] text-[#3F72AF] pl-5 text-[24px] font-medium py-2">FABRIC INHOUSED</h2>
